...
namespace ceph {
  ...
  public:
    ...
    virtual unsigned int get_symbol_count() const = 0;//add by LYF

    virtual int* get_bitmatrix() = 0;//add by LYF
 
    virtual int get_packetsize() = 0;//add by LYF
    ...
    virtual int decode_for_xor(const set<int> &want_to_read,
                       ...
                       int* parity_group_selection) = 0;//add by LYF
